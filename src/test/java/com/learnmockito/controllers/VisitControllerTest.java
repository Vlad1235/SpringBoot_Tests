...
import com.learntotestviajunit5.controllers.VisitController;
...
import com.learntotestviajunit5.services.map.PetMapService;
...
class VisitControllerTest {
  ...
  void loadPetWithVisit() {
    ...
    // так как используем spy, то вызываем реальный метод
